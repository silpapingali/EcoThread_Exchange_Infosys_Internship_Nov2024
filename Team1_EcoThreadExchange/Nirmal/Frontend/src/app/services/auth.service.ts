...
export class AuthService {
  ...
  checkEmailExistence(email: string): Observable<{ exists: boolean ,isSuspended?: boolean}> {
    return this.http.post<{ exists: boolean , isSuspended?: boolean }>(environment.apiUrl+'/api/check-email', { email });
  }
